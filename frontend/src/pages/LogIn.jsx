...
function LogIn() {
    ...
    const { logInShow, setLogInShow, setFollowingStories, getToken } = useAppState()
    ...
    const formik = useFormik({
        ...
        onSubmit: ((values, { resetForm }) => {
            console.log(values)
            logInFunction(values, resetForm, handleErrorMesage, navigate, setErrorMesage, setFollowingStories, getToken)
        }),
    });
